            ...
            <div class="app-search-box col d-flex align-items-center">
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="app-utility-item me-3">
                        <button class="btn btn-primary btn-lg px-4 py-2" data-bs-toggle="modal" data-bs-target="#addTahwissaModal">
                            Ouvrir la modale 1
                        </button>
                    </div>
                    <!-- Second Button -->
                    <div class="app-utility-item">
                        <button class="btn btn-primary btn-lg px-4 py-2" data-bs-toggle="modal" data-bs-target="#addProductModal">
                            Ouvrir la modale 2
                        </button>
                    </div>
                </div>
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                        ...
                        <li><form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="dropdown-item  bg-hover-light">
